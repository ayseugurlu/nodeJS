...
// const loopCount = process.env.LOOP_COUNT // number of loops
// const charCount = process.env.CHAR_COUNT //write 32 for 64
...
const UserSchema = new Schema({
    ...
    password:{
        ...
        set: (password) => (password.length > 5  ? passwordEncrypt(password) : 'InvalidPasssword' ),
